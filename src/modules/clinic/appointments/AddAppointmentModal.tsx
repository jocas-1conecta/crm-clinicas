    ...
    const createMutation = useMutation({
        mutationFn: async () => {
            ...
            const payload: Record<string, unknown> = {
                patient_name: selectedPatient?.name || form.patientName.trim(),
                patient_id: form.patientId || null,
                doctor_name: selectedDoctor?.name || form.doctorName.trim() || null,
                doctor_id: form.doctorId || null,
                specialty: selectedDoctor?.specialty || form.specialty.trim() || null,
                service_name: selectedService?.name || form.serviceName.trim() || null,
